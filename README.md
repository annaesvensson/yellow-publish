...
You can publish your extension at the [command line](https://github.com/annaesvensson/yellow-core). Please make sure that you have completed the [self-review checklist](self-review-checklist.md) before publishing your extension. Are you ready to publish your extension? Check again if you have increased the version number in your code, this is important, so that everybody knows there's a new version of your extension. Open a terminal window. Go to your installation folder, where the file `yellow.php` is. Type `php yellow.php publish all`. You can optionally add the name of a folder. This will update the necessary files. Upload your changes to GitHub and create a pull request for the repository `datenstrom/yellow`.
