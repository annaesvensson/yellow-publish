...
Detta steg är endast nödvändigt för [tillägg på officiella webbplatsen](https://datenstrom.se/sv/yellow/extensions/), det är valfritt för experimentella tillägg. Samma verktyg är tillgängliga för alla. Publicering uppdaterar först tilläggsinställningar. Publicering informerar också uppdateringsmekanismen om att en ny version av ett tillägg är tillgänglig.
