...
- [ ] You checked that your extension settings and repository settings have the same `Description`.
- [ ] You checked that your extension follows the [style guide](style-guide.md) to a reasonable extend.
